      ...
      <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] items-center">
        <div className="space-y-6">
          <div className="flex flex-wrap items-center gap-3">
            <p className="text-xs uppercase tracking-[0.2em] text-secondary font-jetbrains">
              Software Engineer
            </p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-secondary text-lg leading-relaxed md:text-xl">
              I design and build full-stack products that feel calm, clear, and
              reliable. Based in Regensburg — available for freelance projects.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 text-sm text-secondary">
            <span className="rounded-full border border-border bg-contrastDark px-3 py-1">
              Full-stack delivery
            </span>
            <span className="rounded-full border border-border bg-contrastDark px-3 py-1">
              Next.js + TypeScript
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <ButtonLink text="About Me" href="/about" />
          </div>
