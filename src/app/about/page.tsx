...
import CollapsibleResume from "../_components/CollapsibleResume";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "About Me",
  description:
    "Learn more about Michael Kick, a passionate software developer specializing in full-stack development, mobile apps, and AI solutions.",
  openGraph: {
...
const quickFacts = [
  ...
  {
    label: "Core stack",
    value: "TypeScript, React/Next.js, Java, Spring Boot",
  },
